...
ds_map_add(global.weapons[8], "min_damage", 230);
ds_map_add(global.weapons[8], "max_damage", 250);
...
ds_map_add(global.weapons[9], "min_damage", 5);
ds_map_add(global.weapons[9], "max_damage", 9);
