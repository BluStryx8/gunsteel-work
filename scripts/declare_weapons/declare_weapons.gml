...
ds_map_add(global.weapons[4], "min_damage", 30);
ds_map_add(global.weapons[4], "max_damage", 36);
...
ds_map_add(global.weapons[5], "min_damage", 26);
ds_map_add(global.weapons[5], "max_damage", 31);
...
ds_map_add(global.weapons[6], "min_damage", 22);
ds_map_add(global.weapons[6], "max_damage", 26);
...
ds_map_add(global.weapons[7], "min_damage", 20);
ds_map_add(global.weapons[7], "max_damage", 30);
...
ds_map_add(global.weapons[8], "min_damage", 240);
ds_map_add(global.weapons[8], "max_damage", 260);
...
ds_map_add(global.weapons[8], "bullet_dd", 1);
...
ds_map_add(global.weapons[8], "recoil_mult", 10);
...
ds_map_add(global.weapons[8], "reload_time", 60);
...
ds_map_add(global.weapons[9], "min_damage", 6);
...
ds_map_add(global.weapons[9], "base_accuracy", 2);
ds_map_add(global.weapons[9], "recoil", 0.5);
ds_map_add(global.weapons[9], "max_recoil", 7);
ds_map_add(global.weapons[9], "recoil_mult", 0.25);
ds_map_add(global.weapons[9], "shake_dur", 5);
