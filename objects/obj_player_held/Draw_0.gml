...
else
{
	if obj_player.hands == 2
	{
		...
		y = obj_player.y;
		draw_sprite_ext(sprite, 0, x + 7 - obj_player.hand_offset, y + 7, 1, -1, _dir, c_white, 1)
		draw_sprite_ext(spr_player_hand, 0, x + 7 - obj_player.hand_offset,
										y + 7, 1, -1, _dir, global.p_skin_colour, 1)
	}
	else if obj_player.hands == 1
	{
		draw_sprite_ext(sprite, 0, x - 10 - obj_player.hand_offset, y + 7, 1, -1, _dir, c_white, 1)
		draw_sprite_ext(spr_player_hand, 0, x - 10 + obj_player.hand_offset,
						y + 7, 1, -1, _dir, global.p_skin_colour, 1)
	}
}